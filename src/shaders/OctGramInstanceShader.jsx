...
const OctGramInstanceShader = shaderMaterial(
    {
        uTime: 0,
  ...
  `,
    ...
    void main() {
      ...
      vec3 ro = instancePos + vec3(0.0, -0.2, uTime * 4.0);
...
export default OctGramInstanceShader;