...
const CloudTenShaderMaterial = shaderMaterial(
    {
        uTime: 0,
        uMouse: new THREE.Vector2(0.5, 0.5), // Default mouse position
...
extend({ CloudTenShaderMaterial });
export default CloudTenShaderMaterial;