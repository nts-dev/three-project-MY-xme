...
export const useJoystickControls = /* @__PURE__ */ create<State>()(
    /* @__PURE__ */ subscribeWithSelector((set, get) => {
        return {
            ...
            pressButton1: () => {
                set((state) => {
                    return {
                        curButton1Pressed: !state.curButton1Pressed,
                    };
                });
            },
            ...
            releaseAllButtons: () => {
                set((state) => {
                    ...
                    if (state.curButton2Pressed) next.curButton2Pressed = false;
                    if (state.curButton3Pressed) next.curButton3Pressed = false;
                    if (state.curButton4Pressed) next.curButton4Pressed = false;
                    if (state.curButton5Pressed) next.curButton5Pressed = false;
                    return next;
                });
            },
