...
import { canStack } from "./helpers";
import Inventory from "./inventory";
import {itemDictionary} from "./config";

// Mapping: bagId → itemId
const items = {
  3: { id: 7 },
  6: { id: 8 },
  7: { id: 10 },
...
class AppInventory extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      items
  ...
  render() {
    const { itemList,toast } = this.props;
    ...
    return (
        <StyledApp>
          {/*<DndProvider backend={Backend}>*/}
            ...
            {/*    itemDictionary={itemsDictionary}*/}
