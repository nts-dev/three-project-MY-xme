...
export const directoryPickerUnsupportedMessage = () => {
    return 'Opening local project folders requires the File System Access API. Please use a Chromium-based browser such as Chrome or Edge.';
};
